    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CareersInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CareersInfoId = table.Column<int>(type: "int", nullable: false),
                    Icon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Benefits_CareersInfos_CareersInfoId",
                        column: x => x.CareersInfoId,
                        principalTable: "CareersInfos",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CareerPrograms_CareersInfos_CareersInfoId",
                        column: x => x.CareersInfoId,
                        principalTable: "CareersInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HiringSteps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HiringSteps_CareersInfos_CareersInfoId",
                        column: x => x.CareersInfoId,
                        principalTable: "CareersInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPositions_CareersInfos_CareersInfoId",
                        column: x => x.CareersInfoId,
                        principalTable: "CareersInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyValues_CompanyProfiles_CompanyProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Milestones_CompanyProfiles_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Benefits_CareersInfoId",
                table: "Benefits",
                column: "CareersInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_CareerPrograms_CareersInfoId",
                table: "CareerPrograms",
                column: "CareersInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyValues_CompanyProfileId",
                table: "CompanyValues",
                column: "CompanyProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_HiringSteps_CareersInfoId",
                table: "HiringSteps",
                column: "CareersInfoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPositions_CareersInfoId",
                table: "JobPositions",
                column: "CareersInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_Milestones_CompanyProfileId",
                table: "Milestones",
                column: "CompanyProfileId");
